...
- **UX Polish**: Add sticky mobile CTA bar, refine button focus states, and confirm all text meets WCAG contrast ratios.
- **Visual Assets**: Produce high-fidelity hero mock (watch listing) plus a looping micro-demo for the “How it works” section.
- **Experiment Plan**: Set up A/B tests for hero headline (“Know the real price…” vs. “Never overpay again”) and CTA text (“Get instant price prediction” vs. “Start free”).
- **Analytics & Trust**: Instrument scroll/CTA events, add review badge placeholders, and capture testimonial headshots matching the described contexts.
- **Internationalization Prep**: Create copy variants for UK English (fees/shipping terms) and metric units where relevant.
